...
export const AdminIdCheckDuplicate = ({ isLoading, onCheck, checkResult, ...props }) => {
    ...
    return (
        <>
            <FormInput id="email" name="email" value={id} onChange={(e) => setId(e.target.value)} loading={isLoading} />
            <Button
                variant="contained"
                onClick={() => {
                    if (!re.test(id)) {
