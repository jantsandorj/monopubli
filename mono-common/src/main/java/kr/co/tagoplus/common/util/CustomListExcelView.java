...
public class CustomListExcelView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Map<Integer, String>> rows = (List<Map<Integer, String>>) model.get("rows");
		
		@SuppressWarnings("unchecked")
		Map<Integer, String> headers = (Map<Integer, String>) model.get("headers");
