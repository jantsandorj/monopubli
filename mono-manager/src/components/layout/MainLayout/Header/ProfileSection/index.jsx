...
import { getLoggedInUser, setLoggedInUser, setUserToken } from 'utils/functions/common';
    ...
    return (
        <>
            <Chip
                ...
                icon={
                    <Avatar
                        src={process.env.REACT_APP_EGOV_CONTEXT_URL + data?.content.imageAtch[0]?.url}
                        sx={{
                                ...
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    <Box sx={{ p: 2 }}>
                                        <Stack>
                                            ...
                                            <Typography variant="subtitle2">{data?.content?.fullname}</Typography>
                                        </Stack>
                                    </Box>
                                    <Divider />
                                        ...
                                        <Box sx={{ p: 2 }}>
                                            ...
                                            >
                                                <ListItemButton
                                                    ...
                                                    onClick={(event) => handleListItemClick(event, 0, '/member/accountsettings')}
                                                >
                                                    <ListItemIcon>
